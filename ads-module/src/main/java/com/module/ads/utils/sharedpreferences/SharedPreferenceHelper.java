package com.module.ads.utils.sharedpreferences;

import android.annotation.SuppressLint;
import android.content.Context;

import com.chungld.module.ads.BuildConfig;
...
public class SharedPreferenceHelper {
    ...
    public static void initialization(Context context) {
        mSharedPreferencesUtils = SharedPreferencesUtils.newInstance(context, String.format("%s_preference_file", BuildConfig.APPLICATION_ID));
    }
    ...
    public static void increaseIntegerValue(String key) {
        saveInteger(key, getInteger(key, 0) + 1);
    }
